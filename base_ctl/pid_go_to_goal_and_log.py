...
class PIDGoToGoal(Node):
    def __init__(self):
        ...
        self.declare_parameter("yaw_tol", 0.05)     # rad
        self.declare_parameter("slow_dist", 0.30)   # m (within this, scale down vx/vy)

        # speed limits (body frame)
        self.declare_parameter("vx_max", 0.25)      # m/s
        self.declare_parameter("vy_max", 0.25)      # m/s
        ...
        # logging
        self.declare_parameter("out_csv", "/tmp/pid_traj.csv")
        ...
        self._csv.writerow(["t_sec", "x", "y", "yaw", "err_x", "err_y", "err_yaw", "cmd_vx", "cmd_vy", "cmd_wz"])
